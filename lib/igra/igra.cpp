...
void izgubio_si(mole& krtica, coveculjak& cikica1, coveculjak& cikica2, 
                        int& vreme_pokrenut, int& pecurka_pokrenut, bool& igra_zavrsena,
                        GLuint names[], int window_height, int window_width){
    
    kraj_igre(krtica, cikica1,cikica2,vreme_pokrenut,pecurka_pokrenut,igra_zavrsena);
    glColor3f(1.0,1.0,1.0);
    //ispis_fiksiranog_teksta("KRAJ IGRE",350,350,1);
    show_game_over(names,window_height,window_width);
}

void pobedio_si(mole& krtica, coveculjak& cikica1, coveculjak& cikica2, 
                        int& vreme_pokrenut, int& pecurka_pokrenut, bool& igra_zavrsena,
                        GLuint names[], int window_height, int window_width,
    ...
    if(a && vreme>0){
        ...
        ispis_fiksiranog_teksta(std::to_string(krtica.poeni()),440,300,0,window_height,window_width);
    }
}
