...
void initialize(GLuint names[]) {
	...
	// kako bi radilo u image.c sam promenio da drugi argument fje image_read
	// bude konstantan char* a onda sam na internetu pronasao metodu c_str() nad
	// objektima tipa string
...
void ispis_teksta(float x, float y, std::string s, int opcija) {
	...
	// Opcija 1 je za ispis u slucaju da krtica uvlaci trenutno, tekst se
	// ispisuje crveno
...
void ispis_fiksiranog_teksta(std::string s,
							 float x,
							 float y,
							 int opcija,
							 int window_height,
...
void drawCircle(float r, float x, float y) {
	...
	for (float i = 0.0f; i <= 360; i++)
		glVertex3f(r * cos(M_PI * i / 180.0) + x, 0.502,
				   r * sin(M_PI * i / 180.0) + y);
...
void iscrtaj_sargarepu(const sargarepa &s,
	...
	if (!s.pojedena()) {
		...
		for (int i = 0; i < 180; i++) {
			glVertex3f(cos(2 * PI / 180 * i) * 0.049, 0,
					   sin(2 * PI / 180 * i) * 0.049);
		}
		...
		for (int i = 0; i < 180; i++) {
			glVertex3f(cos(2 * PI / 180 * i) * 0.04, -0.04,
					   sin(2 * PI / 180 * i) * 0.04);
		}
		...
		for (int i = 0; i < 180; i++) {
			glVertex3f(cos(2 * PI / 180 * i) * 0.032, -0.07,
					   sin(2 * PI / 180 * i) * 0.032);
		}
		...
		for (int i = 0; i < 10; i++) {
			glVertex3f(cos(2 * PI / 10 * i) * 0.03, 0.1,
					   sin(2 * PI / 10 * i) * 0.03);
			glVertex3f(0, -0.05, 0);
		}
...
void iscrtaj_rotkvicu(const rotkvica &r,
	...
	if (!r.pojedena()) {
		...
		for (int i = 0; i < 8; i += 2) {
			glVertex3f(cos(2 * PI / 8 * i) * 0.05, 0.13,
					   sin(2 * PI / 8 * i) * 0.05);
			glVertex3f(cos(2 * PI / 8 * (i + 1)) * 0.05, 0.13,
					   sin(2 * PI / 8 * (i + 1)) * 0.05);
			glVertex3f(0, 0.02, 0);
		}
		...
		for (int i = 0; i < 8; i += 2) {
			glVertex3f(cos(2 * PI / 8 * (i + 1)) * 0.03, 0.13,
					   sin(2 * PI / 8 * (i + 1)) * 0.03);
			glVertex3f(cos(2 * PI / 8 * (i + 2)) * 0.03, 0.13,
					   sin(2 * PI / 8 * (i + 2)) * 0.03);
			glVertex3f(0, 0.02, 0);
		}
...
void iscrtaj_pecurku(const pecurka &p) {
	if (!p.pojedena()) {
		...
		for (int i = 0; i < 220; i++) {
			glVertex3f(cos(2 * PI / 220 * i) * 0.0801, 0.0,
					   sin(2 * PI / 220 * i) * 0.0801);
		}
		...
		for (int i = 0; i < 180; i++) {
			glVertex3f(cos(2 * PI / 180 * i) * 0.04, 0.0,
					   sin(2 * PI / 180 * i) * 0.04);
		}
